...
> *Effects:* Equivalent to:
> ```
> return os << format(@_STATICALLY_WIDEN_@<charT>("{:%d}{}"), d,
>                     d.ok() ? @_STATICALLY_WIDEN_@<charT>("") :
>                              @_STATICALLY_WIDEN_@<charT>(" is not a valid day"));
> ```
> :::
...
> *Effects:* Equivalent to:
> ```
> return os << format(os.getloc(), @_STATICALLY_WIDEN_@<charT>("{:%b}{}"), m,
>                     m.ok() ? @_STATICALLY_WIDEN_@<charT>("") :
>                              @_STATICALLY_WIDEN_@<charT>(" is not a valid month"));
> ```
> :::
...
> *Effects:* Equivalent to:
> ```
> return os << format(@_STATICALLY_WIDEN_@<charT>("{:%Y}{}"), y,
>                     y.ok() ? @_STATICALLY_WIDEN_@<charT>("") :
>                              @_STATICALLY_WIDEN_@<charT>(" is not a valid year"));
> ```
> :::
...
> *Effects:* Equivalent to:
> ```
> return os << format(os.getloc(), @_STATICALLY_WIDEN_@<charT>("{:%a}{}"), wd,
>                     wd.ok() ? @_STATICALLY_WIDEN_@<charT>("") :
>                               @_STATICALLY_WIDEN_@<charT>(" is not a valid weekday"));
> ```
> :::
...
> ```
> auto i = wdi.index();
> return os << format(os.getloc(), @_STATICALLY_WIDEN_@<charT>("{}[{}{}]"), wdi.weekday(), i,
>                     i >= 1 && i <= 5 ? @_STATICALLY_WIDEN_@<charT>("") :
>                                        @_STATICALLY_WIDEN_@<charT>(" is not a valid index"));
> ```
> :::
...
> *Effects:* Equivalent to:
> ```
> return os << format(@_STATICALLY_WIDEN_@<charT>("{:%F}{}"), ymd,
>                     ymd.ok() ? @_STATICALLY_WIDEN_@<charT>("") :
>                                @_STATICALLY_WIDEN_@<charT>(" is not a valid date"));
> ```
> :::
