...
Let `STATICALLY_WIDEN<charT>("...")` be `"..."` if `charT` is `char` and
...
> *Effects:* Equivalent to:
> ```
> return os << format(STATICALLY_WIDEN<charT>("{:%d}{}"), d,
>                     d.ok() ? STATICALLY_WIDEN<charT>("") :
>                              STATICALLY_WIDEN<charT>(" is not a valid day"));
> ```
> :::
...
> *Effects:* Equivalent to:
> ```
> return os << format(os.getloc(), STATICALLY_WIDEN<charT>("{:%b}{}"), m,
>                     m.ok() ? STATICALLY_WIDEN<charT>("") :
>                              STATICALLY_WIDEN<charT>(" is not a valid month"));
> ```
> :::
...
> *Effects:* Equivalent to:
> ```
> return os << format(STATICALLY_WIDEN<charT>("{:%Y}{}"), y,
>                     y.ok() ? STATICALLY_WIDEN<charT>("") :
>                              STATICALLY_WIDEN<charT>(" is not a valid year"));
> ```
> :::
...
> *Effects:* Equivalent to:
> ```
> return os << format(os.getloc(), STATICALLY_WIDEN<charT>("{:%a}{}"), wd,
>                     wd.ok() ? STATICALLY_WIDEN<charT>("") :
>                               STATICALLY_WIDEN<charT>(" is not a valid weekday"));
> ```
> :::
...
> ```
> auto i = wdi.index();
> return os << format(os.getloc(), STATICALLY_WIDEN<charT>("{}[{}{}]"), wdi.weekday(), i,
>                     i >= 1 && i <= 5 ? STATICALLY_WIDEN<charT>("") :
>                                        STATICALLY_WIDEN<charT>(" is not a valid index"));
> ```
> :::
...
> *Effects:* Equivalent to:
> ```
> return os << format(STATICALLY_WIDEN<charT>("{:%F}{}"), ymd,
>                     ymd.ok() ? STATICALLY_WIDEN<charT>("") :
>                                STATICALLY_WIDEN<charT>(" is not a valid date"));
> ```
> :::
...
> ```
>
> If `%Z` is used, it will be replaced with `STATICALLY_WIDEN<charT>("UTC")`.
...
> ```
>
> If `%Z` is used, it will be replaced with `STATICALLY_WIDEN<charT>("TAI")`.
> If `%z` is used (or a modified variant of `%z`), an offset of `0min` will be
> formatted. The date and time formatted shall be equivalent to that formatted
...
> ```
>
> If `%Z` is used, it will be replaced with `STATICALLY_WIDEN<charT>("GPS")`.
> If `%z` is used (or a modified variant of `%z`), an offset of `0min` will be
> formatted. The date and time formatted shall be equivalent to that formatted
> by a `sys_time` initialized with:
> ```
...
> return formatter<chrono::local_time_format_t<Duration>, charT>::format(
